...
import {
  PenLine, FileText, Crosshair, Zap, Search, X, BookOpen, Star, Menu,
} from "lucide-react";
    ...
    <SidebarProvider defaultOpen={!isMobile}>
      <div className="flex min-h-screen w-full">
        ...
        <div className="flex-1 flex flex-col min-w-0 pb-16 sm:pb-0">
          {/* Sticky top bar with sidebar trigger */}
          <header className={`sticky top-0 z-40 flex items-center gap-3 border-b border-border bg-card/95 px-4 py-2 backdrop-blur transition-shadow ${scrolled ? "shadow-sm" : ""}`}>
          ...
          <main className={mobileTab !== "home" && mobileTab !== "driller" ? "hidden sm:block" : ""}>
            {/* Hero header */}
            <header ref={headerRef} className="border-b border-border bg-card px-6 py-10 text-center sm:py-14">
